...
$user_id_query = "select id from user where email='$e' ";
$user_id_query_result = mysqli_query($conn,$user_id_query) or die(mysqli_error($conn));

$row = mysqli_fetch_array($user_id_query_result);

$ans = $row['id'];
$insert_query = "insert into user_role(id,role_id) values('$ans', '1')";
